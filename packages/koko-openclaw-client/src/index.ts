...
// Node-only transport. Re-exported here for Node consumers (tests, future
// Node-side tooling). RN / browser consumers should NOT import this — they
// should use the protocol layer above and bring their own WebSocket transport
// (see apps/koko-chat).
//
